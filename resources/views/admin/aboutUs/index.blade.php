@extends('layouts.admin', ['pageTitle' => 'About Us', 'newButton' => true, 'newButtonUrl' => 'aboutUs/create', 'newButtonText' => 'new team member', 'active' => 'aboutUs'])
@section('content')
            ...
            @foreach($members as $member)
                <div class="col-md-4" id="{{$member->id}}">
                    <div style="cursor:pointer;text-decoration:none;color:#333;">
                        <a href="{{route('admin.aboutUs.show',$member->id)}}">
                        ...
                        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:10px;">
                            ...
                            <a href="" class="btn btn-danger btn-icon-split" onclick="destroy('{{route('admin.aboutUs.destroy',$member->id)}}','{{$member->id}}','{{$member->id}}')">
