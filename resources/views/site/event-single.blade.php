...
<head>
    ...
    <title>Performing a language for... | Arcworks</title>

    <!-- Lib styles -->
    <link rel="stylesheet" href="../../public/libs/bootstrap-4.3.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="../../public/libs/slick/slick.css">
    <link rel="stylesheet" href="../../public/libs/simpleLightbox/simplelightbox.min.css">

    <!-- Font styles -->
    <link rel="stylesheet" href="../../public/assets/fonts/NunitoSans/NunitoSans.css">
...
<body>
    <header id="main-header" class="site-header is-fixed">
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                <a href="/" class="logo header-logo"><img src="../../public/images/logo.svg" alt=""></a>
            ...
            <div class="row">
                <div class="widget-col col-lg-2">
                    <div class="widget widget-logo">
                        <a href="/" class="logo footer-logo"><img src="../../public/images/logo-footer.svg" alt=""></a>
                    </div>
                </div>
    ...
    <script src="../../public/libs/bootstrap-4.3.1/js/popper.min.js"></script>
    <script src="../../public/libs/bootstrap-4.3.1/js/bootstrap.min.js"></script>
    <script src="../../public/libs/greensock-js/TweenMax.min.js"></script>
    <script src="../../public/libs/scrollreveal/scrollreveal.min.js"></script>
    <script src="../../public/libs/slick/slick.min.js"></script>
    <script src="../../public/libs/simpleLightbox/simple-lightbox.min.js"></script>
    <script src="../../public/libs/isotope/imagesloaded.pkgd.min.js"></script>
    <script src="../../public/libs/isotope/isotope.min.js"></script>
